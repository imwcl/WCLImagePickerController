...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "W_C__L"
  # s.authors            = { "W_C__L" => "18842685026@163.com" }
  # s.social_media_url   = "http://twitter.com/W_C__L"
  ...
  s.exclude_files = 'WCLImagePickerController/**/*.{png,xib,storyboard}'
